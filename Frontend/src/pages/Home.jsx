            ...
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <p>
                  ...
                  Itaque eaque fugiat nihil quidem, non assumenda maxime natus
                  consec
                </p>
        ...
        <Container>
          <Row>
            <Col lg="12" className="text-center">
              ...
              <p className="mb-1 mt-5 feature__text">
            ...
            <Col lg="6" md="6">
              <div className="why__tasty-treat">
                <h2 className="tasty__treat-title mb-4">
                  why <span>Tasty Rreat?</span>
                </h2>
                <p className="tasty__treat-desc">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. At
                  eum aliquid pariatur ratione officiis corporis ipsa magni
                  voluptatem dignissimos est quo, consequuntur vel quibusdam
                  eveniet?
                </p>
                <ListGroup className="mt-4 ">
                  ...
                  <ListGroupItem className="border-0 ps-0">
                    ...
                    <p className="choose__us-desc">
                      Lorem ipsum dolor sit amet hfytcy adipisicing elit. Sequi,
                      iusto!
                    </p>
                  </ListGroupItem>
                  <ListGroupItem className="border-0 ps-0">
            ...
            <Col lg="6" md="6">
              <div className="testimonial ">
                ...
                <p className="testimonial__desc">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Rerum, aspernatur. Nam, delectus magni?
                </p>
                <TestimonialSlider />
              </div>
            </Col>
